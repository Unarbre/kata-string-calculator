    ...
    void should_throw_error_on_alphabetical_characters() {
        ...
        NumberParseException exception = assertThrows(
                NumberParseException.class, () -> CheckedInteger
                        ...
                        .rawValue("a")
                        .build());
        assertEquals("a could'nt be parsed as an integer number", exception.getMessage());
    }

    @Test
    void should_throw_error_on_decimal_value() {
        NumberParseException exception = assertThrows(NumberParseException.class, () -> new CheckedInteger.CheckedIntegerFromStringBuilder()
                .rawValue("3.2")
                .build());
        assertEquals("3.2 could'nt be parsed as an integer number", exception.getMessage());
    }
